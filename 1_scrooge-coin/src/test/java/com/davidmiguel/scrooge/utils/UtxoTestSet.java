package com.davidmiguel.scrooge.utils;

// Copyright (C) 2016-2017 Enrique Albertos
// Distributed under the GNU GPL v2 software license

import com.davidmiguel.scrooge.Transaction;
import com.davidmiguel.scrooge.UTXO;
import com.davidmiguel.scrooge.UTXOPool;
...
public class UtxoTestSet {
     ...
     * @author ealbertos
     */
    public static class UtxoTestSetBuilder {
